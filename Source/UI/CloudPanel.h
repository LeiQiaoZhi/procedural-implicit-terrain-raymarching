	...
	public:
		CloudPanel(const Shader& _shader)
			...
			std::make_shared<GroupProperty>("FBM", std::vector<std::shared_ptr<Property>>{
				std::make_shared<SliderF>("Horizontal Scale", "iCloudHorizontalScale", 0.1f, 10000.0f, 3000.0f),
				std::make_shared<SliderF>("Max Height", "iCloudMaxHeight", 0.0f, 10000.0f, 1200.0f),
